...
- (void)viewDidLoad
{
    ...
    recipe1.length = [recipe1.ingredients count];
    ...
    recipe2.length = [recipe2.ingredients count];
    ...
    recipe3.length = [recipe3.ingredients count];
    ...
    recipe4.length = [recipe4.ingredients count];
    ...
    recipe5.length = [recipe5.ingredients count];
    ...
    recipe6.length = [recipe6.ingredients count];
    ...
    recipe7.length = [recipe7.ingredients count];
    ...
    recipe8.length = [recipe8.ingredients count];
    ...
    recipe9.length = [recipe9.ingredients count];
    ...
    recipe10.length = [recipe10.ingredients count];
    ...
    recipe11.length = [recipe11.ingredients count];
    ...
    recipe12.length = [recipe12.ingredients count];
    ...
    recipe13.length = [recipe13.ingredients count];
    ...
    recipe14.length = [recipe14.ingredients count];
    ...
    recipe15.length = [recipe15.ingredients count];
    ...
    recipe16.length = [recipe16.ingredients count];
